      ...
      <div className="bg-white rounded shadow-md p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <button className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-sm font-medium">
           <li className="flex items-center space-x-2"> <Link to={"/admin/product-comments"}>
        
            Approved Comments</Link></li>
          </button>
        </div>
...
export default PendingProductComments;
