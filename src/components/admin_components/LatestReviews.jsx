  ...
  return (
    <div className="bg-white shadow-md rounded p-6 relative">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-sm">Latest Reviews</h2>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            ...
            <th className="p-2 text-xs font-medium text-gray-500">Id</th>
              <th className="p-2 text-xs font-medium text-gray-500">Username</th>
              <th className="p-2 text-xs font-medium text-gray-500">Review</th>
            </tr>
          </thead>
          <tbody>
